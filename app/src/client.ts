...
const tokenServerUrl = '/api'
const transcriptStoragePrefix = 'fish-voice-chat:transcript:'
const maxPersistedTranscriptItems = 120

const roomInput = document.querySelector<HTMLInputElement>('input#room')
const voiceIdInput = document.querySelector<HTMLInputElement>('input#voice-id')
const connectButton = document.querySelector<HTMLButtonElement>('button#connect')
const disconnectButton = document.querySelector<HTMLButtonElement>('button#disconnect')
const muteButton = document.querySelector<HTMLButtonElement>('button#mute')
const statusText = document.querySelector<HTMLParagraphElement>('p#status')
const statusDot = document.querySelector<HTMLSpanElement>('span#status-dot')
const remoteAudio = document.querySelector<HTMLAudioElement>('audio#remote-audio')
const transcriptLines = document.querySelector<HTMLDivElement>('div#transcript-lines')
