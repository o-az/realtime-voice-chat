/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file ../.env.example` (hash: cabe552dd8e02bc05ae1f8b11276cbcb)
...
interface __BaseEnv_Env {
  ...
  STT_PROVIDER: string
  XAI_STT_LANGUAGE: string
  XAI_STT_ENDPOINTING_MS: string
  LLM_PROVIDER: string
  XAI_LLM_MODEL: string
  OPENAI_LLM_MODEL: string
  BRAVE_SEARCH_COUNTRY: string
  BRAVE_SEARCH_LANGUAGE: string
  BRAVE_SEARCH_SAFESEARCH: string
  TTS_PROVIDER: string
  FISH_TTS_MODEL: string
  FISH_TTS_LATENCY_MODE: string
  FISH_TTS_CHUNK_LENGTH: string
  MISO_TTS_URL: string
  MISO_TTS_MODEL: string
  MISO_TTS_DEVICE: string
  MISO_TTS_DTYPE: string
  MISO_TTS_SPEAKER: string
  MISO_TTS_SAMPLE_RATE: string
  MISO_TTS_MAX_AUDIO_LENGTH_MS: string
  MISO_TTS_TIMEOUT_SECONDS: string
  MISO_TTS_TEMPERATURE: string
  MISO_TTS_TOPK: string
  ENDPOINTING_MIN_DELAY_SECONDS: string
  ENDPOINTING_MAX_DELAY_SECONDS: string
  PREEMPTIVE_TTS: string
  AEC_WARMUP_SECONDS: string
  INTERRUPTION_MODE: string
  INTERRUPTION_MIN_DURATION_SECONDS: string
  RESUME_FALSE_INTERRUPTION: string
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<
      ...
      | 'MISO_TTS_DTYPE'
      | 'MISO_TTS_SPEAKER'
      | 'MISO_TTS_SAMPLE_RATE'
      | 'MISO_TTS_MAX_AUDIO_LENGTH_MS'
      | 'MISO_TTS_TIMEOUT_SECONDS'
      | 'MISO_TTS_TEMPERATURE'
      | 'MISO_TTS_TOPK'
